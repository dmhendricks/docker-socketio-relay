...
See [demo.html](https://github.com/dmhendricks/docker-socketio-relay/blob/master/demo.html) or [Client Side Example Code](https://github.com/dmhendricks/nodejs-simple-message-relay/wiki/Client-Side-Example-Code) for examples of using the Socket.IO browser client to receive messages.
